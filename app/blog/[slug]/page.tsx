...
const postsMeta: Record<string, { title: string; description: string; keywords: string; datePublished: string; image: string }> = {
...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  const image = `https://pixelweb.ge${meta.image}`
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                image: `https://pixelweb.ge${meta.image}`,
                author: {
                  '@type': 'Organization',
                  name: 'PixelWeb.ge',
